...
<p class="fin-lead">
  ...
  DoubleClickjacking and extension tricks need more — but
  <strong>~89% of sites</strong> haven't even shipped the baseline.
</p>
...
<!--
PRESENTER NOTE:
Land the plane: frame-ancestors + XFO is the cheap win for classic clickjacking — most of the room's apps probably lack it.
Acknowledge DCJ and extension clickjacking need more than headers; don't let that become an excuse to skip the baseline.
